...
function setup() {
 ...
 console.log(message)
  ...
  gameOver = createSprite(windowWidth/2,windowHeight-250);
...
function draw() {
  ...
  background(180);
  //displaying score
  text("Score: "+ score, windowWidth-200,windowHeight-windowHeight/1.5);
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   ...
   obstacle.lifetime=-(windowWidth/obstacle.velocityX - 30)
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    cloud.lifetime = windowWidth/3+50;
